...
var LQSContext = /*#__PURE__*/react.createContext();

function LQSContextProvider(_ref) {
  ...
  var _useSessionStorage = reactUse.useSessionStorage("lqs_token", null, true),
      _useSessionStorage2 = _slicedToArray(_useSessionStorage, 2),
      token = _useSessionStorage2[0],
      setToken = _useSessionStorage2[1];
  ...
  var auth = react.useMemo(function () {
    return token != null;
  }, [token]);

  function query(scope, selector, expression) {
    var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    var id = lib.generate();
    return {
      id: id,
      $: backend.multiplex(function () {
        return {
          query: id,
          op: "open",
          scope: scope,
  ...
  function act(_ref2) {
    ...
    if (data) {
      ...
      if (onError || onSuccess) {
        sub = backend.pipe(filter(function (msg) {
          return msg.sid === id;
  ...
  react.useEffect(function () {
    if (url) {
      ...
      var subscription = backendSubject.subscribe(function (msg) {
        setError(null);
  ...
  return /*#__PURE__*/React.createElement(LQSContext.Provider, {
    value: value
  }, children);
}

function useAction(key) {
  var _useContext = react.useContext(LQSContext),
      act = _useContext.act,
      connected = _useContext.connected,
...
function useQuery(scope, initialSelector, initialExpr, initialOptions) {
  ...
  var _useState9 = react.useState(),
      ...
      expr = _useState10[0],
      setExpression = _useState10[1];

  var _useState11 = react.useState(),
      _useState12 = _slicedToArray(_useState11, 2),
      selector = _useState12[0],
      setSelector = _useState12[1];

  var _useContext2 = react.useContext(LQSContext),
      query = _useContext2.query,
      connected = _useContext2.connected,
  ...
  var _useState15 = react.useState(false),
      ...
      closed = _useState16[0],
      setClosed = _useState16[1];
  ...
  react.useEffect(function () {
    if (!isEqual__default['default'](initialSelector, selector)) {
      setSelector(initialSelector);
    }
  }, [initialSelector]);
  react.useEffect(function () {
    if (!isEqual__default['default'](initialExpr, expr)) {
      setExpression(initialExpr);
    }
  }, [initialExpr]);
  react.useEffect(function () {
    if (!isEqual__default['default'](initialOptions, options)) {
  ...
  react.useEffect(function () {
    ...
    setError(null);
    var q = query(scope, selector, expr, options);
    var subscription = q.$.subscribe(function (msg) {
      switch (msg.type) {
        case "result":
          setLoading(false);
          setData(msg.data);
        ...
        default:
          ...
          setError({
            message: "unsupported lqs message"
          });
          break;
      }
    }, function (error) {
...
var LQSContextConsumer = LQSContext.Consumer;

exports.LQSContext = LQSContext;
exports.LQSContextConsumer = LQSContextConsumer;
exports.LQSContextProvider = LQSContextProvider;
